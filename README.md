...
* Organizar exercícios e atividades;
* Armazenar códigos desenvolvidos em aula;
...
A ideia é acompanhar a evolução dos conhecimentos adquiridos desde os primeiros conceitos de lógica de programação até o desenvolvimento de aplicações mais completas.
...
Estudante do curso de **Programador de Sistemas — Senac**.
